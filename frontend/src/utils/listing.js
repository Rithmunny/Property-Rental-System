...
export const AREA_COORDS = {
  ...
  'Toul Tom Poung': { lat: 11.5485, lng: 104.9165 },
  'Chamkar Mon': { lat: 11.5505, lng: 104.9255 },
  'Tonle Bassac': { lat: 11.551, lng: 104.933 },
  'Sen Sok': { lat: 11.592, lng: 104.878 },
  'Chroy Changvar': { lat: 11.59, lng: 104.94 },
  'Chbar Ampov': { lat: 11.535, lng: 104.965 },
  'Mean Chey': { lat: 11.53, lng: 104.92 },
  'Russey Keo': { lat: 11.595, lng: 104.915 },
  Olympic: { lat: 11.558, lng: 104.911 },
  'Wat Bo': { lat: 13.3533, lng: 103.8597 },
  'Old Market': { lat: 13.355, lng: 103.855 },
  'Sala Kamreuk': { lat: 13.362, lng: 103.86 },
  'Svay Dangkum': { lat: 13.368, lng: 103.85 },
  'Wat Damnak': { lat: 13.348, lng: 103.865 },
  'Near University': { lat: 13.102, lng: 103.198 },
  'Wat Kor': { lat: 13.088, lng: 103.195 },
  'Otres Beach': { lat: 10.575, lng: 103.568 },
  'Otres 2': { lat: 10.568, lng: 103.575 },
  Ochheuteal: { lat: 10.598, lng: 103.528 },
  'Independence Beach': { lat: 10.615, lng: 103.518 },
  'Old Town': { lat: 10.61, lng: 104.181 },
  'Teuk Chhou': { lat: 10.64, lng: 104.165 },
  'Kep Beach': { lat: 10.483, lng: 104.316 },
  'Crab Market': { lat: 10.487, lng: 104.308 },
  'Town Center': { lat: 11.99, lng: 105.455 },
  'Cham Yeam': { lat: 11.67, lng: 102.92 },
}
