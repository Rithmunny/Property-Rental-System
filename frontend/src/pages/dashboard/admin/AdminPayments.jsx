    ...
    return (
      <div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="animate-pulse rounded-2xl border border-border bg-card p-5 lg:col-span-1">
    ...
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="rounded-2xl border border-border bg-card p-5 lg:col-span-1">
          ...
          <p className="text-sm text-muted-foreground">How tenants are paying, platform-wide</p>
          <PaymentDonut aba={methods.aba} cash={methods.cash} />
        </div>

        <div className="rounded-2xl border border-border bg-card p-5 lg:col-span-2">
          <h3 className="font-semibold text-foreground">Monthly Collections</h3>
          <p className="text-sm text-muted-foreground">Rent collected across all tenants</p>
          <p className="mt-4 text-3xl font-bold text-foreground">${totalCollected}</p>
